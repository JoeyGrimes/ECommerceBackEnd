...
public class TransactionHistoryServiceImpl implements TransactionHistoryService {
	...
	public List<TransactionHistoryPojo> viewTransactionHistory(int accountid) {
			...
			allTransactionsEntity.forEach((eachEntity)->allTransactionsPojo.add(new TransactionHistoryPojo(eachEntity.getTransactionNo(), eachEntity.getOrderNo(),eachEntity.getAccountId(), eachEntity.getCost(), eachEntity.getQuantity(), eachEntity.getBookTitle(), eachEntity.getBookid())));
